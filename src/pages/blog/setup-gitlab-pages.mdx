...
categories: CI
category_icon: fa-brands fa-gitlab
tags: 
  - ci
  - pages
  - gitlab
...
<p>If you struggle with building the pages, I recommend that you check the <a href="https://gitlab.com/pages" target="_blank" rel="noopener noreferrer">Gitlab examples websites</a> to see how to get your chosen static site deployed Gitlab.</p>
